...
DEMO_CASES = {
    "theft": {
        ...
        "description": "The defendant, Marcus Webb, is charged with stealing a 2024 Tesla Model Y from outside 'The Blue Note' jazz bar on March 14th. A parking-lot camera captured a figure matching Webb's build at 11:47 PM. Webb claims he was inside until midnight; his alibi is bartender Sarah Lin.",
        "questions": [
        ...
        "trial_script": [
            {"agent": "System",     "text": "Court is now in session. The Honorable Judge Adeyemi presiding.",                                                                                                                                       "phase": "Opening"},
            {"agent": "Judge",      "text": "This court is called to order. State versus Marcus Webb, charge of Grand Theft Auto. Prosecution, you may begin.",                                                                                        "phase": "Opening"},
            {"agent": "Prosecutor", "text": "The evidence will show that at precisely 11:47 PM, March 14th, Marcus Webb stole a Tesla Model Y. Security footage places him at the scene. His alibi is a bartender who couldn't track his movements in a packed bar.",  "phase": "Opening"},
            ...
            {"agent": "Fact Checker","text": "✓ 'I don't recall' is within deposition scope.",                                                                                                                                                    "phase": "Witness"},
        ...
        "verdict": "NOT GUILTY", "win_probability": 0.32,
    ...
    "contract": {
        ...
        "description": "Nexus Corp. alleges Aether Labs violated an NDA by sharing proprietary battery schematics with PowerCell Inc. Aether Labs claims the shared information was independently developed and not within scope of the agreement.",
        "questions": [
        ...
        "trial_script": [
            {"agent": "System",     "text": "Civil proceeding in session. The Honorable Judge Park presiding.",                                                                                                                                     "phase": "Opening"},
            {"agent": "Judge",      "text": "Nexus Corp. versus Aether Labs — alleged NDA breach. Plaintiff, you may proceed.",                                                                                                                   "phase": "Opening"},
        ...
        "verdict": "LIABLE", "win_probability": 0.82,
        ...
        if submitted or skipped:
            ...
            if not st.session_state.demo_key:
                ...
                st.session_state.graph_state = {
                    ...
                    "main_verdict":         None,
                    "shadow_jury_results":  {},
                    "multimodal_evidence":  list(st.session_state.get("multimodal_evidence", [])),
                    "errors":               [],
                    **_jx,
                }
